...
# @TODO Find out how to import theme only when making html or pdf target
# To not fail when `make man` in package build process
try:
...
texinfo_documents = [
  ('index', 'Tracer', u'Tracer Documentation',
   u'FrostyX', 'Tracer', 'One line description of project.',
   'Miscellaneous'),
]
